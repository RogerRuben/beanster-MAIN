...
with zipfile.ZipFile(Path(sys.argv[1]) if len(sys.argv)>1 else ROOT/'Beanster-Sips-V18.5.1-unsigned.apk') as z:
    assert z.testzip() is None
    names=set(z.namelist())
    for name in ['app_v5.js','ui_upgrade.js','ui_upgrade.css','ocr_reader.js','motion.js','data_integrity.js','navigation.js','companion.js','local_vision.js','dashboard.js','recognition_flow.js']:
    ...
    assert b'com.beanstersips.v11' in binary_manifest and b'18.5.1' in binary_manifest
