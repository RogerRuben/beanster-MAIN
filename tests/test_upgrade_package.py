...
with zipfile.ZipFile(Path(sys.argv[1]) if len(sys.argv)>1 else ROOT/'Beanster-Sips-V18.5-unsigned.apk') as z:
    ...
    assert b'com.beanstersips.v11' in binary_manifest and b'18.5' in binary_manifest
